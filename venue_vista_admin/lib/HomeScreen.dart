...
import 'package:venue_vista_admin/AuditoriumScreen.dart';
import 'package:venue_vista_admin/EventLog.dart';
import 'package:venue_vista_admin/Title.dart';
import 'package:venue_vista_admin/Report.dart';
              ...
              child: InkWell(
                onLongPress: () {
                  showDialog(context: context, builder:(context) {
                    return AlertDialog(
                      title: Text("Want to Delete image?"),
                      content: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          InkWell(
